...
Mais ceci est contrebalancé par le fait que Nginx ne gère pas les pages dynamiques nativement, ce qui le rend dépendant d'un module externe sur ce point.
Notre site étant composé essentiellement de pages dynamiques Apache est plus intéressant sur ce point
