...
Sert à l'affichage des listes de places, d'université pour les voeux et de l'importation d'universités.

\subsubsection{UniversityController}
Sert à voir/supprimer une université spécifique et à supprimer/éditer/ajouter les places.